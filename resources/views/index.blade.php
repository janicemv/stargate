    ...
    <div class="relative px-6 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl py-15 sm:py-15 lg:py-20">
            ...
            <div class="text-center">
                ...
                <p class="mt-8 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8"> Discover a comprehensive database of Stars and Constellations, featuring astronomical data alongside their cultural, magical, spiritual, and historical connections. </p>
